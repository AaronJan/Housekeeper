...
**`2.0-dev` is here!** More docs and tests are on the way!
...
Powerful `Repository-Pattern` implementation for Laravel `(>= 5.0)` and PHP `(>= 5.5)`, it's really cool and really simple to use.
